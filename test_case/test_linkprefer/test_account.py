...
# 获取excel测试数据
login_data_test = ExcelControl("data/linkprefer/linkprefer_account.xlsx").get_excel_data("login")
register_data_test = ExcelControl("data/linkprefer/linkprefer_account.xlsx").get_excel_data("register")
# 获取yaml配置
