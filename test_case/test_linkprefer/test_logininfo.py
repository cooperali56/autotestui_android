...
# 获取excel测试数据
login_data_test = ExcelControl("data/linkprefer/linkprefer_logininfo.xlsx").get_excel_data("logininfo")
# 获取yaml配置
...
class TestLogininfo:
    ...
    def test_logininfo(self, in_data):
...
if __name__ == '__main__':
    pytest.main(['-q', 'test_logininfo.py'])
