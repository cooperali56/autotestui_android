...
# 获取excel测试数据
login_data_test = ExcelControl("data/linkprefer/linkprefer_campaigns.xlsx").get_excel_data("campaigns")
# 获取yaml配置
...
class TestCampaigns:
    ...
    def test_campaigns(self, in_data):
...
if __name__ == '__main__':
    pytest.main(['-q', 'test_campaigns.py'])
