...
# 获取excel测试数据
login_data_test = ExcelControl("data/linkprefer/linkprefer_paymentsetting.xlsx").get_excel_data("paymentsetting")
# 获取yaml配置
...
class TestPaymentsetting:
    ...
    def test_paymentsetting(self, in_data):
...
if __name__ == '__main__':
    pytest.main(['-q', 'test_paymentsetting.py'])
