...
# 获取excel测试数据
login_data_test = ExcelControl("data/linkprefer/linkprefer_basicinfo.xlsx").get_excel_data("basicinfo")
# 获取yaml配置
...
class TestBasicinfo:
    ...
    def test_basicinfo(self, in_data):
...
if __name__ == '__main__':
    pytest.main(['-q', 'test_basicinfo.py'])
