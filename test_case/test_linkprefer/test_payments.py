...
# 获取excel测试数据
login_data_test = ExcelControl("data/linkprefer/linkprefer_payments.xlsx").get_excel_data("payments")
# 获取yaml配置
...
class TestPayments:
    ...
    def test_payments(self, in_data):
...
if __name__ == '__main__':
    pytest.main(['-q', 'test_payments.py'])
