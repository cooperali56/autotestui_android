...
# 获取excel测试数据
login_data_test = ExcelControl("data/linkprefer/linkprefer_emailsetting.xlsx").get_excel_data("emailsetting")
# 获取yaml配置
...
class TestEmailsetting:
    ...
    def test_emailsetting(self, in_data):
...
if __name__ == '__main__':
    pytest.main(['-q', 'test_emailsetting.py'])
