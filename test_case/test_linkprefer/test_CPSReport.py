...
# 获取excel测试数据
login_data_test = ExcelControl("data/linkprefer/linkprefer_CPSReport.xlsx").get_excel_data("trafficReport")
# 获取yaml配置
...
class TestCPSReport:
    ...
    def test_cpsreport(self, in_data):
...
if __name__ == '__main__':
    pytest.main(['-q', 'test_CPSReport.py'])
