...
# 获取excel测试数据
data_test = ExcelControl("data/rewardoo/rewardoo_account.xlsx").get_excel_data("login")
...
@allure.epic(f"{data_yaml['rewardoo']['project_name']}")
...
class TestAccount:
    ...
    def test_account(self, in_data):
        ...
        # 组合url
        in_data['请求path'] = data_yaml['rewardoo']['account_host'] + in_data['请求path']
