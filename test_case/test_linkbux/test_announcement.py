...
data_test = ExcelControl("data/linkbux/linkbux_announcement.xlsx").get_excel_data("announcement")
# 获取yaml配置
...
if __name__ == '__main__':
    pytest.main(['-q', 'test_announcement.py'])
